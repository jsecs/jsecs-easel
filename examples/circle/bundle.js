...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsecsCore = __webpack_require__(50);
	...
	var CircleComponent = (0, _index.CreateShapeComponent)('circle', {
	  color: 'red',
	  x: 100,
	  y: 200,
	  radius: 50
	...
	var beginSystem = new _jsecsCore.System(engine, function (entities) {
	  entities.add(new _jsecsCore.Entity().attachGroup(CircleComponent));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CreateShapeComponent = exports.default = undefined;

	var _Renderer = __webpack_require__(2);

	var _Renderer2 = _interopRequireDefault(_Renderer);

	var _ShapeComponent = __webpack_require__(3);
	...
	exports.CreateShapeComponent = _ShapeComponent2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var convertIntoNamespace = function convertIntoNamespace(name) {
	  return name;
	};
	...
	var Renderer = function Renderer(engine, id) {
	  ...
	  var renderSystem = new _jsecsCore.System(this.engine, function (entities) {
	    entities.forEach(function (entity) {
	      var type = entity[convertIntoNamespace('renderable')].target;
	      var id = entity.id;
	      switch (type) {
	        case _ShapeComponent.shapeComponentName:
	          var finalTarget = entity[_ShapeComponent.shapeComponentName].target;
	          var props = entity[finalTarget];
	          if (typeof _this.shapes[id] === 'undefined') {
	            _this.shapes[id] = new createjs.Shape();
	            _this.stage.addChild(_this.shapes[id]);
	          }
	          var shape = _this.shapes[id];
	          (0, _ShapeComponent.render)(finalTarget, shape, props);
	          shape.x = props.x;
	          shape.y = props.y;
	          break;
	        default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.render = exports.shapeComponentName = undefined;
	...
	var shapeComponentName = exports.shapeComponentName = convertIntoNamespace('shape');
	var renderComponent = new _jsecsCore.Component(convertIntoNamespace('renderable'), {
	  target: shapeComponentName
	});

	var RenderComponent = function (_Component) {
	  (0, _inherits3.default)(RenderComponent, _Component);
	  (0, _createClass3.default)(RenderComponent, null, [{
	    key: 'render',
	    value: function render(name, shape, props) {
	      RenderComponent.renderers[name].renderCode(shape, props);
	    }
	  }]);

	  function RenderComponent(name, defaultAttributes, renderCode) {
	    (0, _classCallCheck3.default)(this, RenderComponent);

	    var realName = convertIntoNamespace(name);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(RenderComponent).call(this, realName, defaultAttributes));

	    _this.renderCode = renderCode;
	    RenderComponent.renderers[realName] = _this;
	    return _this;
	  }

	  return RenderComponent;
	}(_jsecsCore.Component);

	RenderComponent.renderers = {};


	var newComponent = function newComponent(name, attrs, renderCode) {
	  var comp = new RenderComponent(name, attrs, renderCode);
	  var compName = comp.getName();
	  var shapeComp = new _jsecsCore.Component(shapeComponentName, {
	    target: compName
	  });
	  return new _jsecsCore.ComponentGroup(renderComponent, shapeComp, comp);
	};

	exports.default = newComponent;
	var render = exports.render = RenderComponent.render;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentGroup = __webpack_require__(51);

	var _componentGroup2 = _interopRequireDefault(_componentGroup);

	var _system = __webpack_require__(54);
	...
	var _ecs = __webpack_require__(56);

	var _ecs2 = _interopRequireDefault(_ecs);

	var _entitiesManipulator = __webpack_require__(68);

	var _entitiesManipulator2 = _interopRequireDefault(_entitiesManipulator);

	var _periodicSystem = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentGroup = function () {
	  function ComponentGroup() {
	    ...
	    this.components = _lodash2.default.values(arguments);
	  }

	  _createClass(ComponentGroup, [{
